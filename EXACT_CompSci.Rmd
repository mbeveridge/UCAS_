...
Interesting/unexpected shape to the charts with 'ALevel_points' on the axis. But that's because the text of (eg.) '1 point, 2 points, etc' gets sorted into the order of 1, 11, 12, etc. Need to convert to numeric (or maybe ordered factors?). That would give a shape more like a normal distribution
